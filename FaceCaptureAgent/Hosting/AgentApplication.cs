...
{
    public static WebApplication Build(string[] args, Action<WebApplicationBuilder>? configurePlatform = null)
    {
        ...
        configurePlatform?.Invoke(builder);
    ...
    public static string ResolveConfigPath(string[] arguments)
    {
